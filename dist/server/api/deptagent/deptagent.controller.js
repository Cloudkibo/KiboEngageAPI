...
exports.index = function(req, res) {
  Deptagent.find(function (err, deptagents) {
...
exports.show = function(req, res) {
  ...
  if(req.user.isOwner == 'Yes'){
    User.findOne({email : req.user.ownerAs}, function(err, clientUser){
      ...
      Deptagent.find({companyid : clientUser.uniqueid, deptid: req.params.id, deleteStatus : 'No'}).populate('deptid agentid').exec(function (err, deptagent){
    ...
    Deptagent.find({companyid : req.user.uniqueid, deptid: req.params.id, deleteStatus : 'No'}).populate('deptid agentid').exec(function (err, deptagent){
